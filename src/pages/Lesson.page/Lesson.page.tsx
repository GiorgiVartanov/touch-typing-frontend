      ...
      <div className="list">
        ...
        <ExerciseGroup
          ...
          isAvailable={
            ...
            [1, 2].some((value) => completedAssessments.includes(value))
          }
        />
        <ExerciseGroup
          letters={group_4}
          ...
          isAvailable={
            Array.isArray(completedAssessments) &&
            [1, 2, 3].some((value) => completedAssessments.includes(value))
          }
        />
        <ExerciseGroup
          letters={group_5}
          ...
          isAvailable={
            Array.isArray(completedAssessments) &&
            [1, 2, 3, 4].some((value) => completedAssessments.includes(value))
          }
        />
        <ExerciseGroup
          letters={group_6}
          ...
          isAvailable={
            Array.isArray(completedAssessments) &&
            [1, 2, 3, 4, 5].some((value) => completedAssessments.includes(value))
          }
        />
      </div>
    </PageLayout>

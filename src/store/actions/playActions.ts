...
export const updateSocket = (socket: Socket): { type: typeof UPDATE_SOCKET; payload: Socket } => ({
  type: UPDATE_SOCKET,
  payload: socket,
})

export const updateUID = (uid: string): { type: typeof UPDATE_UID; payload: string } => ({
  type: UPDATE_UID,
  payload: uid,
})

export const updateUsers = (users: string[]): { type: typeof UPDATE_USERS; payload: string[] } => ({
  type: UPDATE_USERS,
  payload: users,
})

export const removeUser = (user: string): { type: typeof REMOVE_USER; payload: string } => ({
  type: REMOVE_USER,
  payload: user,
})
